...
import { LayoutBlank, LayoutGradientBg, Layout } from "./src";
...
<Notes>
  ...
  <p>When the page loads in the browser, the database is queried</p>
  <p>Then an HTML page with db content is generated server-side, and finally served to the client</p>
  <p>Tends to make for a slower site, offloads the slowness onto your user</p>
  <hr />
  <h2>JAMstack workflow</h2>
  <p>Developer typically uses a SSG to build their site</p>
...
<Notes>
  <p>If you’re using a static site generator like Gatsby or React-Static, or tools like react-snapshot that generate a static snapshot of your site, the build tool will generate the static HTML form automatically for you.</p>
