...
<Notes>
  <h2>Decoupled web</h2>
  <p>
    <strong>Javascript:</strong> browser-side functionality (often using a
    framework like React or Angular)
  </p>
  <p>
    <strong>API:</strong> back ends on the server that don't serve back HTML but
    exchange data with you (typically JSON)
  </p>
  <p>
    <strong>Markup:</strong> content / HTML
  </p>
  <hr />
...
<Image
  src="https://snipcart.com/media/204006/jamstack-vs-wordpress-1.png"
  size="75% auto"
/>
...
<Notes>
  <p>
    <strong>Perf:</strong> Serve pre-built markup and assets over a CDN
  </p>
  <p>
...
<Appear>
  ...
  <h2>Headless CMS</h2>
  <p>
    <strong>Open source:</strong> Netlify CMS, Directus, Strapi, Ghost,
    WordPress...
  </p>
  <p>
    <strong>Commercial:</strong> Cosmic JS, Sanity, Forestry, Prismic,
    Contentful, DatoCMS...
  </p>
...
<ul>
  ...
  <li>
    Headless CMS: <strong>none</strong>
  </li>
  <li>
    Version control: <strong>GitHub</strong>
  </li>
  <li>
    Host: <strong>Netlify</strong>
  </li>
</ul>
...
<Notes>
  ...
  <p>
    Allows for continous deployment -> meaning when we push our code, the site
